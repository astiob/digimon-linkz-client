...
namespace UnityEngine.Networking.PlayerConnection
{
	...
	internal class PlayerEditorConnectionEvents
	{
		...
		{
			IEnumerable<PlayerEditorConnectionEvents.MessageTypeSubscribers> enumerable = this.messageTypeSubscribers.Where((PlayerEditorConnectionEvents.MessageTypeSubscribers x) => x.MessageTypeId == messageId);
