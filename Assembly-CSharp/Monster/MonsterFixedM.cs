...
{
	[Serializable]
	public sealed class MonsterFixedM
	{
		...
		public int hpAbilityFlg;

		public int attackAbilityFlg;

		public int defenseAbilityFlg;

		public int spAttackAbilityFlg;

		public int spDefenseAbilityFlg;

		public int speedAbilityFlg;
	}
}
