...
public class ChipEffectStatus : EffectStatusBase
{
	...
	{
		ChipEffectStatus.<GetChipEffectList>c__AnonStorey2E3 <GetChipEffectList>c__AnonStorey2E = new ChipEffectStatus.<GetChipEffectList>c__AnonStorey2E3();
		...
		{
			ChipEffectStatus.<GetChipEffectList>c__AnonStorey2E4 <GetChipEffectList>c__AnonStorey2E2 = new ChipEffectStatus.<GetChipEffectList>c__AnonStorey2E4();
			<GetChipEffectList>c__AnonStorey2E2.<>f__ref$739 = <GetChipEffectList>c__AnonStorey2E;
			ChipEffectStatus.<GetChipEffectList>c__AnonStorey2E4 <GetChipEffectList>c__AnonStorey2E3 = <GetChipEffectList>c__AnonStorey2E2;
			int num = (int)resistanceType;
			<GetChipEffectList>c__AnonStorey2E3.resistance = num.ToString();
			enumerable = chipEffects.Where((GameWebAPI.RespDataMA_ChipEffectM.ChipEffect x) => <GetChipEffectList>c__AnonStorey2E2.<>f__ref$739.searchTargetType(x.targetType.ToInt32()) && x.targetSubType.ToInt32() == (int)<GetChipEffectList>c__AnonStorey2E2.<>f__ref$739.targetSubType && x.targetValue.ToInt32() == <GetChipEffectList>c__AnonStorey2E2.<>f__ref$739.targetValue && x.targetValue2.Contains(<GetChipEffectList>c__AnonStorey2E2.resistance) && <GetChipEffectList>c__AnonStorey2E2.<>f__ref$739.searchEffectType(x.effectType.ToInt32()));
		}
