...
public static class Localization
{
	...
	private static void AddCSV(BetterList<string> newValues, string[] newLanguages, Dictionary<string, int> languageIndices)
	{
		...
		if (Localization.mDictionary.ContainsKey(text))
		{
			...
			{
				global::Debug.LogWarning("Localization key '" + text + "' is already present");
			}
		}
		else
		{
			...
			{
				global::Debug.LogError("Unable to add '" + text + "' to the Localization dictionary.\n" + ex.Message);
			}
		}
	}
	...
	public static string Get(string key)
	{
		...
		{
			global::Debug.LogError("No localization data present");
			return null;
		}
		...
		if (Localization.mLanguageIndex == -1)
		{
			...
			global::Debug.LogWarning("Language not found: " + language);
		}
