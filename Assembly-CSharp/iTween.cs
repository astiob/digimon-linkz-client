...
public class iTween : MonoBehaviour
{
	...
	public static void CameraFadeFrom(float amount, float time)
	{
		...
		{
			global::Debug.LogError("iTween Error: You must first add a camera fade object with CameraFadeAdd() before atttempting to use camera fading.");
		}
	}
	...
	public static void ValueTo(GameObject target, Hashtable args)
	{
		...
		{
			global::Debug.LogError("iTween Error: ValueTo() requires an 'onupdate' callback function and a 'from' and 'to' property.  The supplied 'onupdate' callback must accept a single argument that is the same type as the supplied 'from' and 'to' properties!");
			return;
		}
		args["type"] = "value";
		...
		else
		{
			...
			{
				global::Debug.LogError("iTween Error: ValueTo() only works with interpolating Vector3s, Vector2s, floats, ints, Rects and Colors!");
				return;
			}
			args["method"] = "color";
		}
	...
	public static void AudioFrom(GameObject target, Hashtable args)
	{
		...
		else
		{
			...
			{
				global::Debug.LogError("iTween Error: AudioFrom requires an AudioSource.");
				return;
			}
	...
	private void GenerateTargets()
	{
		...
		case "color":
		{
			...
			if (text2 != null)
			{
				...
				{
					iTween.<>f__switch$mapC = new Dictionary<string, int>(1)
					{
						{
							"to",
							0
				...
				int num2;
				if (iTween.<>f__switch$mapC.TryGetValue(text2, out num2))
				{
					if (num2 == 0)
					{
		...
		case "audio":
		{
			...
			if (text2 != null)
			{
				...
				{
					iTween.<>f__switch$mapD = new Dictionary<string, int>(1)
					{
						{
							"to",
							0
				...
				int num2;
				if (iTween.<>f__switch$mapD.TryGetValue(text2, out num2))
				{
					if (num2 == 0)
					{
		...
		case "move":
		{
			...
			if (text2 != null)
			{
				...
				{
					iTween.<>f__switch$mapE = new Dictionary<string, int>(3)
					{
						{
							"to",
							0
				...
				int num2;
				if (iTween.<>f__switch$mapE.TryGetValue(text2, out num2))
				{
					if (num2 != 0)
					{
						if (num2 == 1)
	...
	private void GenerateAudioToTargets()
	{
		...
		{
			global::Debug.LogError("iTween Error: AudioTo requires an AudioSource.");
			this.Dispose();
		}
	...
	private void GenerateLookToTargets()
	{
		...
		{
			global::Debug.LogError("iTween Error: LookTo needs a 'looktarget' property!");
			this.Dispose();
		}
	...
	private void GenerateMoveToPathTargets()
	{
		...
		if (this.tweenArguments["path"].GetType() == typeof(Vector3[]))
		{
			...
			if (array.Length == 1)
			{
				global::Debug.LogError("iTween Error: Attempting a path movement with MoveTo requires an array of more than 1 entry!");
				this.Dispose();
			}
			array2 = new Vector3[array.Length];
			Array.Copy(array, array2, array.Length);
	...
	public static void AudioUpdate(GameObject target, Hashtable args)
	{
		...
		else
		{
			if (!target.GetComponent<AudioSource>())
			{
				global::Debug.LogError("iTween Error: AudioUpdate requires an AudioSource.");
				return;
			}
			audioSource = target.GetComponent<AudioSource>();
		}
	...
	public static void LookUpdate(GameObject target, Hashtable args)
	{
		...
		global::Debug.LogError("iTween Error: LookUpdate needs a 'looktarget' property!");
	}
	...
	public static Hashtable Hash(params object[] args)
	{
		...
		if (args.Length % 2 != 0)
		{
			global::Debug.LogError("Tween Error: Hash requires an even number of arguments!");
			return null;
		}
	...
	private static void DrawLineHelper(Vector3[] line, Color color, string method)
	{
		...
		for (int i = 0; i < line.Length - 1; i++)
		{
			...
			{
				global::Debug.LogError("iTween Error: Drawing a line with Handles is temporarily disabled because of compatability issues with Unity 2.6!");
			}
		}
	}
	...
	private static void DrawPathHelper(Vector3[] path, Color color, string method)
	{
		...
		for (int i = 1; i <= num; i++)
		{
			...
			{
				global::Debug.LogError("iTween Error: Drawing a path with Handles is temporarily disabled because of compatability issues with Unity 2.6!");
			}
			to = vector;
		}
	}
	...
	private void RetrieveArgs()
	{
		...
		if (this.tweenArguments.Contains("namedcolorvalue"))
		{
			...
			else
			{
				...
				{
					global::Debug.LogWarning("iTween: Unsupported namedcolorvalue supplied! Default will be used.");
		...
		if (this.tweenArguments.Contains("looptype"))
		{
			...
			else
			{
				...
				{
					global::Debug.LogWarning("iTween: Unsupported loopType supplied! Default will be used.");
		...
		if (this.tweenArguments.Contains("easetype"))
		{
			...
			else
			{
				...
				{
					global::Debug.LogWarning("iTween: Unsupported easeType supplied! Default will be used.");
		...
		if (this.tweenArguments.Contains("space"))
		{
			...
			else
			{
				...
				{
					global::Debug.LogWarning("iTween: Unsupported space supplied! Default will be used.");
	...
	private void CallBack(string callbackType)
	{
		if (this.tweenArguments.Contains(callbackType) && !this.tweenArguments.Contains("ischild"))
		{
			...
			{
				global::Debug.LogError("iTween Error: Callback method references must be passed as a String!");
