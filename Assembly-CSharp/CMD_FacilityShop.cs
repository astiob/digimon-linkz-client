...
public sealed class CMD_FacilityShop : CMD
{
	...
	{
		CMD_FacilityShop.<SetFacilityDetail>c__AnonStorey371 <SetFacilityDetail>c__AnonStorey = new CMD_FacilityShop.<SetFacilityDetail>c__AnonStorey371();
	...
	{
		CMD_FacilityShop.<SetNewIcon>c__AnonStorey373 <SetNewIcon>c__AnonStorey = new CMD_FacilityShop.<SetNewIcon>c__AnonStorey373();
