...
public class CustomTypewriterEffect : MonoBehaviour
{
	public static CustomTypewriterEffect current;

	private string customText_ = string.Empty;
	...
	private BetterList<CustomTypewriterEffect.FadeEntry> mFade = new BetterList<CustomTypewriterEffect.FadeEntry>();
