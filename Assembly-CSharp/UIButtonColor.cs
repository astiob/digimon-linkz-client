...
{
	public bool useTweenTarget = true;
	...
	{
		this.mInitDone = true;
		if (!this.useTweenTarget && !Application.isPlaying)
		{
			this.tweenTarget = null;
		}
		if (this.tweenTarget == null && !Application.isPlaying && this.useTweenTarget)
		{
			this.tweenTarget = base.gameObject;
		}
		if (this.tweenTarget != null && !this.useTweenTarget)
		{
