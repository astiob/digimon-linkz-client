...
public class ExtraEffectStatus : EffectStatusBase
{
	...
	{
		ExtraEffectStatus.<GetExtraEffectStatusList>c__AnonStorey2E7 <GetExtraEffectStatusList>c__AnonStorey2E = new ExtraEffectStatus.<GetExtraEffectStatusList>c__AnonStorey2E7();
		...
		{
			ExtraEffectStatus.<GetExtraEffectStatusList>c__AnonStorey2E8 <GetExtraEffectStatusList>c__AnonStorey2E2 = new ExtraEffectStatus.<GetExtraEffectStatusList>c__AnonStorey2E8();
			<GetExtraEffectStatusList>c__AnonStorey2E2.<>f__ref$743 = <GetExtraEffectStatusList>c__AnonStorey2E;
			ExtraEffectStatus.<GetExtraEffectStatusList>c__AnonStorey2E8 <GetExtraEffectStatusList>c__AnonStorey2E3 = <GetExtraEffectStatusList>c__AnonStorey2E2;
			int num = (int)resistanceType;
			<GetExtraEffectStatusList>c__AnonStorey2E3.resistance = num.ToString();
			enumerable = extraEffectStatusList.Where((ExtraEffectStatus x) => (x.TargetType == (int)<GetExtraEffectStatusList>c__AnonStorey2E2.<>f__ref$743.targetType || x.TargetType == 0) && x.TargetSubType == (int)<GetExtraEffectStatusList>c__AnonStorey2E2.<>f__ref$743.targetSubType && x.TargetValue == <GetExtraEffectStatusList>c__AnonStorey2E2.<>f__ref$743.targetValue && x.TargetValue2.Contains(<GetExtraEffectStatusList>c__AnonStorey2E2.resistance) && <GetExtraEffectStatusList>c__AnonStorey2E2.<>f__ref$743.searchEffectType(x.EffectType));
		}
