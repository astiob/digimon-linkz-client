...
namespace UnityStandardAssets.ImageEffects
{
	...
	public class VignetteAndChromaticAberration : PostEffectsBase
	{
		...
		public override bool CheckResources()
		{
			...
			this.m_VignetteMaterial = base.CheckShaderAndCreateMaterial(this.vignetteShader, this.m_VignetteMaterial, string.Empty);
			this.m_SeparableBlurMaterial = base.CheckShaderAndCreateMaterial(this.separableBlurShader, this.m_SeparableBlurMaterial, string.Empty);
			this.m_ChromAberrationMaterial = base.CheckShaderAndCreateMaterial(this.chromAberrationShader, this.m_ChromAberrationMaterial, string.Empty);
			if (!this.isSupported)
			{
