...
namespace UnityStandardAssets.ImageEffects
{
	...
	internal class CreaseShading : PostEffectsBase
	{
		...
		public override bool CheckResources()
		{
			...
			this.blurMaterial = base.CheckShaderAndCreateMaterial(this.blurShader, this.blurMaterial, string.Empty);
			this.depthFetchMaterial = base.CheckShaderAndCreateMaterial(this.depthFetchShader, this.depthFetchMaterial, string.Empty);
			this.creaseApplyMaterial = base.CheckShaderAndCreateMaterial(this.creaseApplyShader, this.creaseApplyMaterial, string.Empty);
			if (!this.isSupported)
			{
