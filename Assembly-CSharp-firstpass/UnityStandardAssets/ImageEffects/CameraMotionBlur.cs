...
namespace UnityStandardAssets.ImageEffects
{
	...
	public class CameraMotionBlur : PostEffectsBase
	{
		...
		public override bool CheckResources()
		{
			...
			this.motionBlurMaterial = base.CheckShaderAndCreateMaterial(this.shader, this.motionBlurMaterial, string.Empty);
			if (this.supportDX11 && this.filterType == CameraMotionBlur.MotionBlurFilter.ReconstructionDX11)
			{
				this.dx11MotionBlurMaterial = base.CheckShaderAndCreateMaterial(this.dx11MotionBlurShader, this.dx11MotionBlurMaterial, string.Empty);
			}
			if (!this.isSupported)
			{
