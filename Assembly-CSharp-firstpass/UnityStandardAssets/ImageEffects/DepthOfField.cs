...
namespace UnityStandardAssets.ImageEffects
{
	...
	public class DepthOfField : PostEffectsBase
	{
		...
		public override bool CheckResources()
		{
			...
			this.dofHdrMaterial = base.CheckShaderAndCreateMaterial(this.dofHdrShader, this.dofHdrMaterial, string.Empty);
			if (this.supportDX11 && this.blurType == DepthOfField.BlurType.DX11)
			{
				this.dx11bokehMaterial = base.CheckShaderAndCreateMaterial(this.dx11BokehShader, this.dx11bokehMaterial, string.Empty);
