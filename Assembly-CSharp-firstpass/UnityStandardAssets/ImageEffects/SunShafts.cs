...
namespace UnityStandardAssets.ImageEffects
{
	...
	public class SunShafts : PostEffectsBase
	{
		...
		public override bool CheckResources()
		{
			...
			this.sunShaftsMaterial = base.CheckShaderAndCreateMaterial(this.sunShaftsShader, this.sunShaftsMaterial, string.Empty);
			this.simpleClearMaterial = base.CheckShaderAndCreateMaterial(this.simpleClearShader, this.simpleClearMaterial, string.Empty);
			if (!this.isSupported)
			{
