...
namespace UnityStandardAssets.ImageEffects
{
	...
	public class BloomOptimized : PostEffectsBase
	{
		...
		public override bool CheckResources()
		{
			...
			this.fastBloomMaterial = base.CheckShaderAndCreateMaterial(this.fastBloomShader, this.fastBloomMaterial, "Hidden/FastBloom");
			if (!this.isSupported || this.fastBloomMaterial == null)
			{
				base.ReportAutoDisable();
			}
			else if (Application.isPlaying)
			{
				this.fastBloomShader = this.fastBloomMaterial.shader;
			}
