...
namespace UnityStandardAssets.ImageEffects
{
	...
	public class ColorCorrectionCurves : PostEffectsBase
	{
		...
		public override bool CheckResources()
		{
			...
			this.ccMaterial = base.CheckShaderAndCreateMaterial(this.simpleColorCorrectionCurvesShader, this.ccMaterial, string.Empty);
			this.ccDepthMaterial = base.CheckShaderAndCreateMaterial(this.colorCorrectionCurvesShader, this.ccDepthMaterial, string.Empty);
			this.selectiveCcMaterial = base.CheckShaderAndCreateMaterial(this.colorCorrectionSelectiveShader, this.selectiveCcMaterial, string.Empty);
